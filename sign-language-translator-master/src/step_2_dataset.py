...
class SignLanguageMNIST(Dataset):
    ...
    def __init__(self,
            path: str="data/alphabet/sign_mnist_train/sign_mnist_train.csv",
...
def get_train_test_loaders(batch_size=32):
    trainset = SignLanguageMNIST('data/alphabet/sign_mnist_train/sign_mnist_train.csv')
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=batch_size, shuffle=True)

    testset = SignLanguageMNIST('data/alphabet/sign_mnist_test/sign_mnist_test.csv')
